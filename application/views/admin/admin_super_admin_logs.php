    ...
    <div class="row" style="min-height: 700px">
        ...
        <div class="col-md-12">     
            <div class="card bg-white">
                <h2 class="p-2 m-0 teal text-center rounded-top text-white">List of All Logs (Super Admin)</h2>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-12">
                                <select class="mdb-select" searchable="Search Name" name="id">
                                    ...
                                    <?php
                                    foreach ($super_admin_names_ids->result() as $row) 
                                    {
                                    ?>
                                        <option value="<?php echo md5(md5($row->super_admin_id))?>"><?php echo $row->first_name.' '.$row->last_name?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                ...
                <div class="card-body table-responsive" style="max-height: 700px">
                    ...
                    <table id="" class="table table-sm table-striped table border-top table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                        foreach ($super_admin_logs->result() as $row) 
                        {
                        ?>
                            <tr>
