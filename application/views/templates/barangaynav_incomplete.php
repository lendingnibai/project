...
<header>
    <!-- Sidebar navigation -->
    <div id="slide-out" class="side-nav teal darken-4 fixed d-none">
        ...
        <li>
            <ul class="collapsible collapsible-accordion">
                ...
                <li><a class="collapsible-header waves-effect arrow-r <?php if (isset($active_transactions)){echo 'active';}?>"><i class="fa fa-money"></i> <strong>Transactions</strong>
                    <span class="badge badge-danger rounded-circle">50</span>
                    <i class="fa fa-angle-down rotate-icon"></i></a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="<?php echo base_url();?>barangay/manage_funds" class="waves-effect"> <i class="fa fa-money"></i>Fundings <span class="badge badge-danger rounded-circle">11</span></a>
                            </li>
                            <li><a href="<?php echo base_url();?>barangay/loans" class="waves-effect"> <i class="fa fa-money"></i>Loans <span class="badge badge-danger rounded-circle">19</span></a>
                            </li>
                            <li><a href="<?php echo base_url();?>barangay/investments" class="waves-effect"> <i class="fa fa-money"></i>Invetsments <span class="badge badge-danger rounded-circle">15</span></a>
                            </li>
                            <li><a href="<?php echo base_url();?>barangay/withdrawals" class="waves-effect"> <i class="fa fa-money"></i>Withdrawals <span class="badge badge-danger rounded-circle">10</span></a>
                            </li>
                            <li><a href="<?php echo base_url();?>barangay/payments" class="waves-effect"> <i class="fa fa-money"></i>Payments <span class="badge badge-danger rounded-circle">2</span></a>
                            </li>
                            <li><a href="<?php echo base_url();?>barangay/earnings" class="waves-effect"> <i class="fa fa-money"></i>Earnings <span class="badge badge-danger rounded-circle">1</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav teal darken-3">
        ...
        <!-- Brand -->
      <a class="navbar-brand ml-5" href="<?php echo base_url();?>barangay">
        ...
        <ul class="nav navbar-nav nav-flex-icons ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link waves-effect">
                     <strong><?php echo $brgy_user_details['position']?></strong> <?php echo $brgy_user_details['first_name'].' '.substr($brgy_user_details['middle_name'], 0, 1).'. '.$brgy_user_details['last_name'] ?> (<?php echo $brgy_user_details['email']?>)
                </a>
            </li>
            <li class="nav-item dropdown">
              ...
              <img src="<?php echo base_url($brgy_user_details['profile'])?>" alt="Profile" style="width: 25px; height: 25px" class="rounded-circle">
          </a>
...
<div class="container-fluid">
    ...
    <div class="container">
        <ol class="breadcrumb">
            <li class="breadcrumb-item m-auto"><h6><?php echo $title?></h6></li>
        </ol>
    </div>