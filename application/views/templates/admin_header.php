...
<head>
    ...
    <title>Admin <?php echo $title; ?> | MangJuam</title>
    <!-- Font Awesome -->
    ...
    <!-- cosutom-->
    <link href="<?php echo base_url()?>public/css/switch_colors.min.css" rel="stylesheet">
    <!-- datatables -->
...
<body class="fixed-sn grey lighten-5">
