    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto smooth-scroll">
          ...
          <li class="nav-item active animated bounce" id="investMenu">
    ...
    <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
          <div class="view" style="background-image: url('<?php echo base_url()?>public/img/carousel/invest.png');background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="container wow fadeIn" style="width: 450px; margin-left: 12%; margin-top: -10%">
              <img src="<?php echo base_url()?>public/img/carousel/investc.png" class="animated bounce rounded img-responsive w-100">
            </div>
            <!-- Content -->
  ...
  <main class="mainlayout">
    ...
    <div class="container">
        ...
        <section class="section team-section my-2 wow fadeIn">
          ...
          <h2 class="my-2 dark-grey-text h4 text-center" data-wow-delay="0.2s">
                INVESTING IN PERSONAL LOANS AND SMALL BUSINESS LOANS
          </h2>
    ...
    <hr class="my-5">
        ...
        <section class="section team-section text-center my-2 wow fadeIn">
          ...
          <div class="text-center">
            <a href="" data-toggle="modal" id="startinvestingnow" data-target="#modalRegForm" data-backdrop="static">
              <button class="btn btn-primary btn-md animated bounce wow fadeIn">START INVESTING NOW</button>
            </a>
          </div>
      ...
      <span class="dark-grey-text">
        ...
        *computation results are for estimation purposes only. These do not constitute an approval nor offer by MangJuam<br>
        ...
        <form class="container-fluid mb-2 p-4 border rounded-bottom border-default">
          <!-- Default input email -->
          <label for="defaultFormLoginEmailEx" class="dark-grey-text text-left m-1 h6 float-left">Desire amount min. 5,000</label>
