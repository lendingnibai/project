...
<!--Modal: modalLoanApp-->
<div class="modal fade modalLoanApp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg Large modal-notify modal-info" role="document">
      <!--Content-->
      <div class="modal-content ">
         <!--Header-->
         <div class="modal-header d-flex">
            <p class="heading">Loan Application</p>
            ...
            <table class="w-100">
               <tr>
                  ...
                  <td class="w-50">
                     ...
                     <p class="font-weight-bold"><span class="ajax_loan_amount"></span></p>
                     <p class="font-weight-bold"><span class="ajax_loan_term"></span></p>
                     <hr>
            ...
            <table class="w-100">
               <tr>
                  ...
                  <td class="w-50">
                     ...
                     <p class="font-weight-bold">Water/Electric Bill:</p>
                     <a href="" class="ajax_href_bill" target="_blank" title="View full">
                         <img class="img-fluid card ajax_bill" src="" style="width: 98%; height: 200px">
                     </a>
                  </td>
               </tr>
               <tr>
                   <td colspan="2" class="w-100">
                      <p class="mt-3">
                        <span class="font-weight-bold ajax_req_title"></span> 
                        <a href="" class="ajax_text_view" target="_blank"></a>
                    </p>
                  </td>
               </tr>
            </table>
         ...
         <div class="modal-footer text-center flex-center mt-0">
            <form method="POST" action="<?php echo base_url('barangay/accept_loan_app')?>">
               <br>
               ...
               <input type="hidden" name="id" value="" id="ajax_user_loan_id_hide">
               ...
               <button type="submit" formaction="<?php echo base_url('barangay/reject_loan_app')?>" class="btn btn-danger m-0 ml-2 btn-sm py-1 px-3" title="Reject" onclick="return confirm('Are you sure you want to reject this application?')">
               <b>&#10008;</b>
               </button>
            </form>
         </div>
            ...
            <table class="w-100">
               <tr>
                  <td class="w-100">
                     ...
                     <br>
                     <p class="font-weight-bold float-left">Water/Electric Bill:</p>
                     <a href="" class="ajax_href_bill" target="_blank" title="View full">
                        <img class="img-fluid card ajax_bill" src="" style="width: 100%; height: 230px">
                     </a>
                     <p class="mt-3">
                        <span class="font-weight-bold ajax_req_title"></span> 
                        <a href="" class="ajax_text_view" target="_blank"></a>
      ...
      <div class="modal-content ">
         ...
         <div class="modal-body" id="printMe">
            ...
            <div class="declaration border border-dark mt-5" id="declaration">
               ...
               <div class="px-2">
                  <em class="text-dark ">
                  I hereby declare that all information disclosed is correct, complete and truly stated. I hereby declare that I am authorized to make this loan and that the amount loan in the Fund/s is through legitimate sources only.
                  <br>
         ...
         <div class="modal-footer flex-center">
            <button type="button" title="print" id="printLoanApp" class="btn btn-sm btn-info rounded"><i class="fa fa-print" aria-hidden="true"></i></button>
         </div>
      </div>
      <!--/.Content-->
   </div>
...
<section class="wow fadeIn">
   ...
   <!-- Loan fund -->
   <div class="card mb-2 <?php echo $visibility_for_approval?>" id="new_loan">
      <div class="card-body table-responsive">
         <!--Table-->
         <p class="dark-grey-text">Loan application received</p>
         <table class="table table-sm table-bordered">
            ...
            <tbody>
               <?php $seq = 1; ?>
               <?php foreach ($new_loan_app->result() as $row) {?>
               <tr>
                  ...
                  <td>
                     <button class="btn_get_id_for_loan_app btn btn-info m-0 btn-sm py-1 px-3" title="View More Details" id="<?php echo $row->loan_application_id.md5($seq)?>">
                     View
                     </button>
                  </td>
               </tr>
               <?php $seq++; }?>
               <button class="d-none" id="btn_modal_view_loan_app" type="button" data-toggle="modal" data-target=".modalLoanApp"></button>
            </tbody>
            <!--Table body-->
         </table>
         <!--Table-->
...
<section class="wow fadeIn">
   <div class="row" style="min-height: 700px">
      <div class="col-md-12">
         <div class="card">
            <h5 class="p-2 m-0 teal text-center rounded-top text-white">List of Loan Applications</h5>
            <div class="card-body table-responsive">
               <table id="dtBasicExample" class="table table-sm table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     <?php $seq = 1; ?>
                     <?php $table_seq = $loan_app_accepted->num_rows();?>
                     <?php foreach ($loan_app_accepted->result() as $row){?>
                     <?php $terms_in_word = ($row->loan_term > 1) ? 'Months' : 'Month' ;?>
                     <?php $funded_status = ($row->is_released) ? '&#8369;' .number_format($row->loan_amount,2) : 'Not yet';?>
                     <tr>
                        ...
                        <td><?php echo $funded_status ?></td>
                        <td class="text-center">
                           <button id="<?php echo $row->loan_application_id.md5($seq)?>" class="btn_get_id_for_loan_app_details btn btn-info btn-sm py-1 m-0 px-3" title="View Loan App.">View</button>
                        </td>
                        <td class="text-center">
                           <button id="<?php echo $row->loan_application_id.md5($seq.'req');?>" class="btn_get_id_for_req btn btn-info btn-sm m-0 py-1 px-3" title="View Requirements">View</button>
                        </td>
                     </tr>
                     <?php $seq++; ?>
                     <?php $table_seq--; }?>
                     <button class="d-none" id="btn_modal_view_loan_app_printable" type="button" data-toggle="modal" data-target=".modalDetails"></button>
