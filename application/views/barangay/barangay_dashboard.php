...
<section class="wow fadeIn">
    ...
    <div class="view overlay mb-3">
        <img src="<?php echo base_url($brgy_details['photo_brgy'])?>" class="img-fluid w-100 rounded" alt="Sample image with waves effect.">
        <a>
            ...
            <div class="card">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-7 col-7 text-right pr-5">
                        ...
                        <p class="font-small grey-text">Active Lenders</p>
                    </div>
                </div>
                <!--/.Card Data-->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-7 col-7 text-right pr-5">
                        <h5 class="ml-4 mt-4 mb-2 font-weight-bold">4,567 </h5>
                        <p class="font-small grey-text">Active Borrowers</p>
                    </div>
                </div>
                <!--/.Card Data-->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-5 col-5 text-left pl-4">
                        <a type="button" class="btn-floating btn-lg danger-color ml-4 animated pulse infinite" data-toggle="tooltip" data-placement="top" title="New user for approval">
...
<section class="mt-2 wow fadeIn">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                <div class="card-header white-text teal">
                    <span class="h6">Total Fund </span><i class="fa fa-2x fa-money float-right" aria-hidden="true" style="margin-top: -6px"></i>
                </div>

                <h5 class="ml-4 mt-5 dark-grey-text font-weight-bold"><i class="fa fa-long-arrow-up blue-text mr-3" aria-hidden="true"></i> ₱ 2,000.00</h5>
                <!--/.Card Data-->

                <!--Card content-->
                <div class="card-body">
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg teal rounded-right" role="progressbar" style="width: 45%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <!--Text-->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                <div class="card-header white-text teal">
                    <span class="h6">Loans</span> <i class="fa fa-2x fa-money float-right" aria-hidden="true" style="margin-top: -6px"></i>
                </div>
                ...
                <div class="card-body">
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg teal rounded-right" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <!--Text-->
                    <p class="font-small grey-text">Better than last week (25%)</p>
                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                <div class="card-header white-text teal">
                    <span class="h6">Investments</span> <i class="fa fa-2x fa-money float-right" aria-hidden="true" style="margin-top: -6px"></i>
                </div>

                <h5 class="ml-4 mt-5 dark-grey-text font-weight-bold"><i class="fa fa-long-arrow-down red-text mr-3" aria-hidden="true"></i> ₱ 2,000.00</h5>
                <!--/.Card Data-->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card">
                <div class="card-header white-text teal">
                    <span class="h6">Earnings</span> <i class="fa fa-2x fa-money float-right" aria-hidden="true" style="margin-top: -6px"></i>
                </div>
...
<section class="mb-5 wow fadeIn">
    ...
    <!--Card image-->
        <div class="view gradient-card-header teal rounded">

            <div class="row">
                <div class="col-6">
                    <!-- Chart -->
                    <canvas id="investment" height="200px"></canvas>
                </div>

                <div class="col-6">
                    <!-- Chart -->
                    <canvas id="sales" height="200px"></canvas>
                </div>
            </div>
        ...
        <div class="col-lg-8 col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <button class="btn btn-flat grey lighten-3 btn-rounded waves-effect font-weight-bold dark-grey-text float-right">View full report</button>
        ...
        <div class="col-xl-3 col-md-6 mb-2">
            ...
            <div class="card">
                ...
                <div class="row mt-4 mb-3">
                    <div class="col-md-3 col-3 text-left pl-4">
                        <!--Facebook-->
                        <a class="p-2 m-2 fa-lg fb-ic"><i class="fa fa-facebook fa-2x blue-text"> </i></a>
                    </div>
            ...
            <div class="card mt-4">
                ...
                <div class="row mt-4 mb-3">
                    <div class="col-md-3 col-3 text-left pl-4">
                        <!--Facebook-->
                        <a class="p-2 m-2 fa-lg fb-ic"><i class="fa fa-google-plus fa-2x red-text"> </i></a>
                    </div>
            ...
            <div class="card mt-4 mb-4">
                ...
                <div class="row mt-4 mb-3">
                    <div class="col-md-3 col-3 text-left pl-4">
                        <!--Facebook-->
                        <a class="p-2 m-2 fa-lg fb-ic"><i class="fa fa-twitter fa-2x cyan-text"> </i></a>
                    </div>
