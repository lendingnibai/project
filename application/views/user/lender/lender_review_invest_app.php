      ...
      <div class="modal-content ">
         ...
         <div class="modal-body" id="printMe">
            <div class="text-center">
               <img src="" class="ajax_photo_bgry" class="img-fluid" style="width: 150px; height: 150px; border-radius: 50%">
         ...
         <div class="modal-footer flex-center">
            <button type="button" title="print" id="printInvestApp" class="btn btn-sm btn-info rounded d-none"><i class="fa fa-print" aria-hidden="true"></i></button>
         </div>
      </div>
      <!--/.Content-->
   </div>
   ...
   <div class="container-fluid dark-grey-text">
      ...
      <section class="section investbook-section my-5 wow fadeIn">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Review Investment Applications <i class="fa fa-leanpub" aria-hidden="true"></i></li>
         </ol>
         ...
         <div class="row mt-3" style="min-height: 600px">
            <div class="col-md-12">
               <div class="card">
                  <h4 class="p-2 m-0 teal text-center rounded-top text-white">List of Investment Applications</h4>
                     ...
                     <table id="dtBasicExample" class="table table-sm table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                           <?php
                              ...
                              foreach ($invest_app->result() as $row) 
                              {
                              ...
                              $seq = 1;
                              $table_seq = $invest_app->num_rows();
                              foreach ($invest_app->result() as $row) 
                              {
                                $status_in_word_color = '';
                                $re_apply_visibility = 'd-none';
                                
                                $terms_in_word = ($row->invest_term > 1) ? 'Years' : 'Year' ;
                           ...
                           <tr>
                              ...
                              <td class="text-right pr-2"><?php echo number_format($row->invest_amount,2) ?></td>
                              ...
                              <td class="text-center">
                                 <span class="btn btn-sm m-0 p-1 btn-info text-primary btn_get_id_for_app" id="<?php echo $row->investment_application_id.md5($seq)?>" title="View full details"style="cursor: pointer;">
                                 View
                                 </span>
                              </td>
                              <td class="text-center">
                                 <a href="<?php echo base_url('lender/re_apply?investment_app='.$row->investment_application_id.md5($seq).'&brgy='.$row->registered_brgy_id.md5($seq))?>">
