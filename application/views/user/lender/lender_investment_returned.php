  ...
  <div class="container-fluid dark-grey-text">
    ...
    <section class="section monthly-returned-section my-5 wow fadeIn">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Investment returned <i class="fa fa-leanpub" aria-hidden="true"></i></li>
      </ol>
      ...
      <div class="row mt-3" style="min-height: 600px">
        ...
        <div class="col-md-12"> 
          ...
          <div class="card table-responsive">
              <h4 class="p-2 m-0 teal accent-4 text-center rounded-top text-white">Investment Returned History</h4>
              <div class="card-body">
                  <table id="dtBasicExample" class="table table-sm table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php $seq = $my_investment_returned->num_rows()?>
                      <?php if ($my_investment_returned->num_rows() > 0){?>
                        <?php foreach ($my_investment_returned->result() as $row){?>
                        <tr>
