      ...
      <div class="rounded p-2 white mt-3 card" style="min-width: 700px">
        ...
        if ($user_settings == 'b_settings') 
        {
          ?>
            <div class="container mt-0">
              <span class="active">Email <i class="fa fa-envelope" aria-hidden="true"></i></a> / 
              <a href="<?php echo base_url();?>borrower/settings/change-username" title="Change Username">Username</span> / 
        ...
        else
        {
          ?>
            <div class="container mt-0">
              <span class="active">Email <i class="fa fa-envelope" aria-hidden="true"></i></a> / 
              <a href="<?php echo base_url();?>lender/settings/change-username" title="Change Username">Username</span> / 
        ...
        <div class="view overlay m-auto">
            ...
            <p class="text-center"><?php echo $user_details['email']?></p>
        </div>

        <div class="container-fluid animated zoomIn">
          <div class="border border-default rounded mb-4 mx-auto p-4 w-50">
            <input type="text" value="" placeholder="New email" class="my-2 mx-auto form-control">
            <input type="password" value="" placeholder="*********" class=" my-2 mx-auto form-control">
            <div class="text-center">
              <button type="submit" class="btn btn-md btn-primary mx-auto my-2 w-100">Change email</button>
            </div>
          </div>
        </div>
