  ...
  <div class="container-fluid dark-grey-text">
    ...
    <section class="section loanbook-section my-5 wow fadeIn">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Loan Received <i class="fa fa-money" aria-hidden="true"></i></li>
      </ol>
               ...
               <div class="card table-responsive">
                  ...
                  <div class="card-body">
                     <table id="dtBasicExample" class="table table-sm table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        <tbody>
                           <?php $seq = $my_loans->num_rows()?>
                           <?php if ($my_loans->num_rows() > 0){?>
                           <?php foreach ($my_loans->result() as $row){?>
                           <tr>
