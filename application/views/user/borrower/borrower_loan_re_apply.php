    ...
    <div class="container-fluid dark-grey-text">
        ...
        <section class="section loan-section my-5">
            ...
            <div class="rounded p-2 card white mt-3 wow fadeIn" style="min-width: 700px">
                ...
                <hr>
                <form id="re_apply_loan_app_form" method="post" action="<?php echo base_url('borrower/re_apply_loan')?>" enctype="multipart/form-data">
                    <div class="row" style="min-width: 700px">
                        <div class="col-xl-6 col-md-12 pl-4 ">
                          <!-- get the loan id -->
                          <input type="hidden" name="loan_app_id" value="<?php echo $_GET['loan_app']?>">
                            <!-- Default input email -->
                            <div class="row mb-0 ">
                                ...
                                <div class="col">
                                    <select class="mdb-select md-form mt-0 loan_term" id="loan_term" name="loan_term">
                                        ...
                                        <?php
                                         ...
                                         {
                                          $one_m = $two_m = $three_m = $four_m = $five_m = $six_m = $seven_m = $eight_m = $nine_m = $ten_m = $eleven_m = $twelve_m = '';
                                           foreach ($monthly_term->result() as $row) 
                                           {
                                            if ($row->one_mo == $loan_term) 
                                            {
                                              $one_m = 'selected';
                                            }
                                            elseif ($row->two_mo == $loan_term) 
                                            {
                                              $two_m = 'selected';
                                            }
                                            elseif ($row->three_mo == $loan_term) 
                                            {
                                              $three_m = 'selected';
                                            }
                                            elseif ($row->four_mo == $loan_term) 
                                            {
                                              $four_m = 'selected';
                                            }
                                            elseif ($row->five_mo == $loan_term) 
                                            {
                                              $five_m = 'selected';
                                            }
                                            elseif ($row->six_mo == $loan_term) 
                                            {
                                              $six_m = 'selected';
                                            }
                                            elseif ($row->seven_mo == $loan_term) 
                                            {
                                              $seven_m = 'selected';
                                            }
                                            elseif ($row->eight_mo == $loan_term) 
                                            {
                                              $eight_m = 'selected';
                                            }
                                            elseif ($row->nine_mo == $loan_term) 
                                            {
                                              $nine_m = 'selected';
                                            }
                                            elseif ($row->ten_mo == $loan_term) 
                                            {
                                              $ten_m = 'selected';
                                            }
                                            elseif ($row->eleven_mo == $loan_term) 
                                            {
                                              $eleven_m = 'selected';
                                            }
                                            elseif ($row->twelve_mo == $loan_term) 
                                            {
                                              $twelve_m = 'selected';
                                            }
                                             if($row->one_mo){ echo'<option value="'.$row->one_mo.'" '.$one_m.'>'.$row->one_mo.' month</option>';}
                                             if($row->two_mo){ echo'<option value="'.$row->two_mo.'" '.$two_m.'>'.$row->two_mo.' months</option>';}
                                             if($row->three_mo){ echo'<option value="'.$row->three_mo.'" '.$three_m.'>'.$row->three_mo.' months</option>';}
                                             if($row->four_mo){ echo'<option value="'.$row->four_mo.'" '.$four_m.'>'.$row->four_mo.' months</option>';}
                                             if($row->five_mo){ echo'<option value="'.$row->five_mo.'" '.$five_m.'>'.$row->five_mo.' months</option>';}
                                             if($row->six_mo){ echo'<option value="'.$row->six_mo.'" '.$six_m.'>'.$row->six_mo.' months</option>';}
                                             if($row->seven_mo){ echo'<option value="'.$row->seven_mo.'" '.$seven_m.'>'.$row->seven_mo.' months</option>';}
                                             if($row->eight_mo){ echo'<option value="'.$row->eight_mo.'" '.$eight_m.'>'.$row->eight_mo.' months</option>';}
                                             if($row->nine_mo){ echo'<option value="'.$row->nine_mo.'" '.$nine_m.'>'.$row->nine_mo.' months</option>';}
                                             if($row->ten_mo){ echo'<option value="'.$row->ten_mo.'" '.$ten_m.'>'.$row->ten_mo.' months</option>';}
                                             if($row->eleven_mo){ echo'<option value="'.$row->eleven_mo.'" '.$eleven_m.'>'.$row->eleven_mo.' months</option>';}
                                             if($row->twelve_mo){ echo'<option value="'.$row->twelve_mo.'" '.$twelve_m.'>'.$row->twelve_mo.' months</option>';}
                                           }
                                         } 
                                         ?>
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <input type="text" value="<?php echo $loan_amount?>" min="<?php echo $min_loan?>" max="<?php echo $max_loan?>" name="loan_amount" id="loan_amount" placeholder="Loan Amount <?php echo number_format($min_loan,2)?> - <?php echo number_format($max_loan,2)?>"" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-4 m-auto d-none d-md-block">
                                    ...
                                    <select class="mdb-select md-form mt-0" searchable="Search here.." id="co_maker_1" name="co_maker_1">
                                        ...
                                        <?php if ($co_makers->num_rows() > 0) {?>
                                          <?php foreach ($co_makers->result() as $row) {?>
                                            <?php if ($row->lender_id == $co_maker_1){?>
                                              <option value="<?php echo $row->lender_id.md5($row->lender_id)?>" data-icon="<?php echo base_url($row->photo)?>" class="rounded-circle" selected><?php echo $row->co_maker?></option>
                                              <?php }  else{ ?>
                              ...
                              <div class="col-4 m-auto d-none d-md-block">
                                ...
                                <div class="col">
                                    <select class="mdb-select md-form mt-0" searchable="Search here.." id="co_maker_2" name="co_maker_2">
                                        ...
                                        <?php if ($co_makers->num_rows() > 0) {?>
                                          <?php foreach ($co_makers->result() as $row) {?>
                                            <?php if ($row->lender_id == $co_maker_2){?>
                                              <option value="<?php echo $row->lender_id.md5($row->lender_id)?>" data-icon="<?php echo base_url($row->photo)?>" class="rounded-circle" selected><?php echo $row->co_maker?></option>
                                              <?php }  else{ ?>
                                              <option value="<?php echo $row->lender_id.md5($row->lender_id)?>" data-icon="<?php echo base_url($row->photo)?>" class="rounded-circle"><?php echo $row->co_maker?></option>
                                              <?php } ?>
                            ...
                            <div class="" id="sourceOfIncomeOption">
                                <div class="row mb-0">
                                    ...
                                    <div class="col">
                                        <select class="mdb-select md-form source_of_income" name="source_of_income">
                                            <option value="" selected disabled>Select</option>
                                            <?php $business = $self_emp = $employee = '';?>
                                            <?php if ($source_of_income == 'Business'){?>
                                              <option value="Business" selected>Business</option>
                                            <?php }elseif ($source_of_income == 'Self Employed'){?>
                                              <option value="Self Employed" selected>Self Employed</option>
                                            <?php }elseif ($source_of_income == 'Employee'){?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <input type="text" value="<?php echo $monthly_income?>" name="monthly_income" id="monthly_income" placeholder="Monthly Income" class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <span class="float-left d-none d-sm-block d-md-none">Bill <small class="red-text">*</small></span>
                                            <input type="file" name="photo_file[]" id="bill" accept='image/*' class="form-control d-none">
                                        </div>
                                        <div class="col m-auto">
                                            <a class="grey-text" id="file9">1 file selected</a>
                                        </div>
                                        <div class="col-2 m-auto" id="reviewPhotoBill">
                                ...
                                <div class="row mb-3" title="Payslip Month 1">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            ...
                                            <div class="col m-auto">
                                                <a class="grey-text" id="file2">1 file selected</a>
                                            </div>
                                            <div class="col-2 m-auto" id="reviewPhotopayslip1">
                                ...
                                <div class="row mb-3" title="Barangay permit">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            ...
                                            <div class="col m-auto">
                                                <a class="grey-text" id="file5">1 file selected</a>
                                            </div>
                                            <div class="col-2 m-auto" id="reviewPhotoBrgyPermit">
                                ...
                                <div class="row mb-3" title="Mayor's permit">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            ...
                                            <div class="col m-auto">
                                                <a class="grey-text" id="file6">1 file selected</a>
                                            </div>
                                            <div class="col-2 m-auto" id="reviewPhotoMayorPermit">
                    ...
                    <center>
                        <input type="submit" name="btn_submit" value="Re-apply Loan" class="btn btn-primary btn-sm my-3">
                    </center>
                </form>
            </div>
        </section>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="p-2">
                ...
                <span id="filename1">Government ID</span>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="p-2">
                ...
                <img src="<?php echo base_url($payslip)?>" alt="Payslip" id="previewPhotopayslip1" width="100%" height="100%">
            </div>
        </div>
        <!--/.Content-->
    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="p-2">
                ...
                <img src="<?php echo base_url($brgy_permit)?>" alt="Barangay Permit" id="previewPhotoBrgyPermit" width="100%" height="100%">
            </div>
        </div>
        <!--/.Content-->
    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="p-2">
                ...
                <img src="<?php echo base_url($mayor_permit)?>" alt="Mayor's Permit" id="previewPhotoMayorPermit" width="100%" height="100%">
            </div>
        </div>
        <!--/.Content-->
    </div>
...
<div class="modal fade" id="previewPhotoModalBill" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="p-2">
                <a href="" class="float-right h6 red-text" data-dismiss="modal"><small>Close</small></a>
                <span id="filename9">Water/Electric Bill</span>
                <img src="<?php echo base_url($water_elect_bill)?>" alt="Bill" id="previewPhotoBill" width="100%" height="100%">
            </div>
        </div>
        <!--/.Content-->
    </div>
